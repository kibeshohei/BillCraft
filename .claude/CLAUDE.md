...
| Phase 1 | 認証（Userモデル・登録・ログインページ） | 🔄 次 |
| Phase 2 | ダッシュボード基盤（レイアウト・サイドバー・請求書一覧ページ） | 未着手 |
| Phase 3 | 請求書作成（フォーム・DB保存・バリデーション） | 未着手 |
| Phase 4 | PDF出力（@react-pdf/rendererでテンプレート作成・ダウンロード） | 未着手 |
| Phase 5 | 請求書管理（一覧の実データ・詳細・編集・削除） | 未着手 |
